...
You can use Github Pages to create a website for your repositories. The url for the Research Org will be https://sites.njit.edu/reponame; while the Academic Org will be https://njit-academics.github.io/reponame
...
!!! note "Digital Accessibility Requirements"

    ARCS reserves the right to disable github pages and revoke users ability to maintain and administer a repo if they fail to meet Digital Accessbility Requirements. Please see the SNOW KB article for [Accessibility Resources](https://nexus.njit.edu/highlander_nexus?id=kb_article&sysparm_article=KB0010228&table=kb_knowledge&searchTerm=accessibility) and ensure that the content is made accessible to individuals with disabilities in order to comply with Title II standards. More on the regulations can be found here: https://www.ada.gov/law-and-regs/regulations/title-ii-2010-regulations/. 
